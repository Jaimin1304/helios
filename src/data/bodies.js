 ...
 * palette tints each body's distant dot; surface appearance comes from the declared textures.
 */
...
export const BODIES = [
  // ────────────────────────────── Star ──────────────────────────────
  {
    ...
    palette: ['#7a1500', '#ff6a10', '#ffb648', '#fff6d8'],
  ...
  // ────────────────────────────── Planets ──────────────────────────────
  {
    ...
    palette: ['#3b3531', '#6b6158', '#8f857a', '#b0a698'],
  ...
  },
  {
    ...
    palette: ['#8a6626', '#c69a4a', '#e6cf90', '#fff2cc'],
  ...
  },
  {
    ...
    palette: ['#071d3d', '#0e3c66', '#2f6b34', '#7d6f43'],
    tex: {
  ...
  },
  {
    ...
    palette: ['#4d2312', '#8a4122', '#b56a3a', '#d99f6c'],
  ...
  // ────────────────────────── Moons of Jupiter ──────────────────────────
  {
    ...
    palette: ['#8f6a12', '#d8b32c', '#f2e08a', '#a33418'],
    tex: generatedTexture('io'),
  ...
  },
  {
    ...
    palette: ['#7d6b53', '#cbbca4', '#efe8dc', '#8a5f43'],
    tex: generatedTexture('europa'),
  ...
  },
  {
    ...
    palette: ['#3f3830', '#7b7264', '#a89e8e', '#c7bdad'],
    tex: generatedTexture('ganymede'),
  ...
  },
  {
    ...
    palette: ['#241f1b', '#4e463e', '#786d5f', '#968a79'],
    tex: generatedTexture('callisto'),
  ...
  // ─────────────────────────── Moons of Saturn ───────────────────────────
  {
    ...
    palette: ['#5e5e62', '#97979c', '#c2c2c7', '#e2e2e6'],
    tex: generatedTexture('mimas'),
  ...
  },
  {
    ...
    palette: ['#241d16', '#584c3c', '#a09484', '#d6cfc2'],
    tex: generatedTexture('iapetus'),
  ...
  // ─────────────────────────── Moons of Uranus ───────────────────────────
  {
    ...
    palette: ['#4a4a4e', '#7d7d82', '#a5a5ab', '#c6c6cb'],
    tex: generatedTexture('miranda'),
    orbit: km(129390, 0.0013, 4.232, 0, 68.3, 311.3, 1.413479),
  },
  {
    id: 'ariel', name: '天卫一 · 艾瑞尔', en: 'Ariel', parent: 'uranus', kind: 'moon', radius: 578.9,
    palette: ['#5c5c62', '#96969e', '#c4c4cb', '#e2e2e8'],
    tex: generatedTexture('ariel'),
  ...
  },
  {
    ...
    palette: ['#2b2b2e', '#4f4f54', '#6e6e74', '#8c8c92'],
    tex: generatedTexture('umbriel'),
  ...
  },
  {
    ...
    palette: ['#453c36', '#786b60', '#9d9084', '#bdb1a4'],
    tex: generatedTexture('titania'),
    orbit: km(436300, 0.0011, 0.340, 0, 284.4, 96.7, 8.705872),
  },
  {
    id: 'oberon', name: '天卫四 · 奥伯龙', en: 'Oberon', parent: 'uranus', kind: 'moon', radius: 761.4,
    palette: ['#3d3630', '#6d6157', '#918578', '#b0a596'],
    tex: generatedTexture('oberon'),
  ...
  // ─────────────────────────── Moons of Neptune ──────────────────────────
  {
    ...
    palette: ['#7d7480', '#c0b6c2', '#e9e1ea', '#a08f9c'],
    tex: generatedTexture('triton'),
  ...
  },
  {
    ...
    palette: ['#4a3227', '#8a6249', '#c2a184', '#e6d6bf'],
    tex: generatedTexture('pluto'),
  ...
  },
  {
    ...
    palette: ['#3a3a3e', '#6a6a70', '#909096', '#b2b2b8'],
    tex: generatedTexture('charon'),
